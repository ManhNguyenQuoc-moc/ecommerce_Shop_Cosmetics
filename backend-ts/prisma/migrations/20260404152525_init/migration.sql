...
(
    ...
    "note" TEXT,
    "priority" "POPriority" NOT NULL DEFAULT 'NORMAL',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Batch_variantId_batchNumber_purchaseOrderId_key" ON "Batch"("variantId", "batchNumber", "purchaseOrderId");
