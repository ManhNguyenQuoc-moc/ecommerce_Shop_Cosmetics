...
router.post("/bulk-import", authenticate, permissionGuard("product", "create"), productController.importProducts);
router.post("/variants", authenticate, permissionGuard("variant", "create"), productController.createVariant);
router.post("/variants/bulk-import", authenticate, permissionGuard("variant", "create"), productController.importVariants);
