...
import { useCreateCategoryGroup, useUpdateCategoryGroup } from "@/src/services/admin/category/category-group.hook";
import { CATEGORY_GROUP_API_ENDPOINT } from "@/src/services/admin/category/category-group.service";
