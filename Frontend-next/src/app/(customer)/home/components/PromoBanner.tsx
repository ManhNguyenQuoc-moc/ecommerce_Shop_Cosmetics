        ...
        <div className="relative h-full container mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4">
               <h3 className="text-white text-lg md:text-2xl font-black tracking-tight">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden lg:flex items-center gap-6 mr-4">
               <div className="text-right">
                  <p className="text-white/30 text-[10px] font-bold uppercase tracking-widest">Kết thúc sau</p>
                  <p className="text-brand-100 font-mono font-bold">04:23:15</p>
               </div>
            </div>
            ...
            >
              SĂN NGAY <ArrowRight size={18} className="group-hover/btn:translate-x-1 transition-transform" />
            </SWTButton>
          </div>
        </div>
